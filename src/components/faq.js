      ...
      <div className={faqStyles.inner}>
        <div className={faqStyles.questions}>
          ...
          <div className={faqStyles.block}>
            <h3 className={faqStyles.blockTitle}>Valóban ingyenes a bővítmény?</h3>
            <p className={faqStyles.blockDescription}>Igen, ezt a bővítményt, a jelenlegi formájában <a href="https://github.com/conedevelopment/simplepay-gateway/blob/master/LICENSE">MIT licensz</a> alatt költségek nélkül töltheted le és használhatod.</p>
          </div>
          <div className={faqStyles.block}>
